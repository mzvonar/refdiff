...
`node scripts/baseline-matching.ts` at refdiff `28095fe` (WORKING TREE DIRTY — the numbers below are not a committed state).
...
Measured 2026-09-16T07:09:39.934Z.
...
| refdiff-compare-desktop-ghost        |   43 |    23 |    2 |  24 |    2 |     2 |     7 |    1 |    1 |   1 |     3 |  109 |
| TOTAL (9)                            | 1049 |   264 |  191 | 333 |   90 |    48 |   116 |   75 |   21 |  32 |    13 | 2232 |
...
| major | extra-element | text | 6/9 | 144 |  | implementation renders "4" (7×14) that the design does not have |
...
| doc-detail-accountant-mobile    |    7 |     6 |   15 |  21 |    5 |    12 |     9 |    9 |    1 |   4 |     2 |   91 |
...
| major | color | text | 2/14 | 4 | color=rgb(185, 171, 151) → color=rgb(44, 36, 25) | "ZÚČT. OBDOBIE" text color is rgb(44, 36, 25), design says rgb(185, 171, 151) (ΔE2000 51.2) |
| major | typography | text | 2/14 | 4 | fontSize=9 fontWeight=600 → fontSize=12.5 fontWeight=500 | "ZÚČT. OBDOBIE" typography differs: size 12.5px vs 9px, weight 500 vs 600 |
...
| major | color | text | 2/14 | 2 | color=rgb(44, 36, 25) → color=rgb(78, 122, 90) | "−650,00 €" text color is rgb(78, 122, 90), design says rgb(44, 36, 25) (ΔE2000 33.2) |
...
| minor | typography | text | 2/14 | 3 | fontSize=11.5 → fontSize=10.5 | "Vyberte transakciu, ku ktorej doklad chý…" typography differs: size 10.5px vs 11.5px |
...
| minor | typography | text | 2/14 | 2 | fontSize=12 fontWeight=600 → fontSize=14 fontWeight=500 | "Vyžiadať doklad" typography differs: size 14px vs 12px, weight 500 vs 600 |
