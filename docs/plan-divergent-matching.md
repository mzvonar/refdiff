...
> **STATUS (2026-09-15).** Steps 0, 1, 2, 3 and 4 DONE. Not pushed. 474 core + 380 annotator green.
>
...
>
> **DO NEXT: THE RECONCILE WORKSTREAM** (added 2026-09-16 — reconcile steps 1, 2, 3), which now
> comes BEFORE step 5. Steps 0–4 are DONE. Step 4 shipped the `reconcile` label and nothing about
