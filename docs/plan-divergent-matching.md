...
> **STATUS (2026-09-15).** Steps 0, 1 and 2 DONE (`73cc4a1`, `164828a`, `29c43ee`, `df83394`).
> Not pushed. 462 core + 380 annotator tests green.
>
...
>
> **DO NEXT: step 3** (give the corpus pairs that can see harm to the polish loop). Baseline:
...
detail and say why. 29 of the 34 corpus pairs are below confidence 0.5, so this is the COMMON case,
not an edge one — and today every one of them gets a full element-wise report anyway.
