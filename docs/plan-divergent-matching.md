...
> **STATUS (2026-09-15).** Phase 1 DONE (steps 0 and 1: `73cc4a1`, `164828a`) and **step 2 DONE**
> (`29c43ee` formatting, then the harness). Not pushed. 462 core + 380 annotator tests green.
> **DO NEXT: step 3** (container-scoped matching with sequence alignment) — measured against
